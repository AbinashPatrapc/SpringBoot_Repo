...
public class WishMessageController {
	...
	public String showHome() {
	  ...
	  @RequestMapping("/wish") public String
	  fetchWishMessage(Map<String,Object>map) {
	  String msg=service.WishMessageGenerator(); map.put("wishMsg", msg);
	  map.put("sysdate", new Date());
	  return "forward:wish1"; }
	  
	  @RequestMapping("/wish1") public String
	  fetchWishMessage1(Map<String,Object>map) {
	  String msg=service.WishMessageGenerator(); map.put("wishMsg", msg);
	  map.put("sysdate", new Date());
	  return "show_result"; }
