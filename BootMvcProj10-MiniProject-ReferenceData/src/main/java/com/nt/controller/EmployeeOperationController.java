...
//	}
	...
	public Set<String> populateCountry(){
		Set<String> countryList=service.getAllCountry();
		return countryList;
	}
	
	@PostMapping("/stateurl")
	public String populateState(@RequestParam("country") String country,@ModelAttribute("emp")Employee emp,Map<String,Object>map){
